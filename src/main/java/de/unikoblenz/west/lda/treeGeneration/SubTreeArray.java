...
public class SubTreeArray {
	...
	/*
	public void addBefore(int[] string) {
	...
	*/
	...
	/*	
	public void addAfter(int[] string) {
		this.subtree = Arrays.copyOf(this.subtree, this.subtree.length + string.length);
...
*/
	...
	private void addLevelSeparatorAfter() {
		...
		this.subtree = Arrays.copyOf(this.subtree, this.subtree.length + 1);
	    this.subtree[this.subtree.length - 1] = levelSeparator;
	}
